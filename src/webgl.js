 ...
 *
 * Replaces the pixel data for an existing texture. This is used for live
 * sources such as <video>, where allocating a new WebGLTexture every frame
 * would quickly become wasteful.
 */
